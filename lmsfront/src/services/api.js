...
export const API = {
  ...
  course_delete: (admin_course_id) => `${API_URL}/admin/course/delete?course_id=${admin_course_id}`, 
  course_restore: (admin_course_id) => `${API_URL}/admin/course/restore?course_id=${admin_course_id}`,
  course_add_student: (admin_course_id) => `${API_URL}/course/students/add?course_id=${admin_course_id}`,
  course_remove_student: (admin_course_id) => `${API_URL}/course/students/remove?course_id=${admin_course_id}`,
  course_add_teacher: (admin_course_id) => `${API_URL}/course/teachers/add?course_id=${admin_course_id}`,
  course_remove_teacher: (admin_course_id) => `${API_URL}/course/teachers/remove?course_id=${admin_course_id}`,
  list_admin_course: `${API_URL}/admin/course/all`,
  admin_logs: (lines) => `${API_URL}/admin/logs?${lines}`,
  admin_logs_all: `${API_URL}/admin/logs/all`,
  admin_settings: `${API_URL}/admin/settings`,
  admin_settings_logo: `${API_URL}/admin/settings/upload-image`,
